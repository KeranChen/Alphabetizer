...
all: stringBST alphabetizer

stringBST: stringBST.o testStringBST.o 
	${CXX} ${LDFLAGS} -o stringBST StringBST.o testStringBST.o 


alphabetizer: alphabetizer.o main.o StringBST.o
	${CXX} ${LDFLAGS} -o alphabetizer Alphabetizer.o main.o 
...
testStringBST.o:        testStringBST.cpp        StringBST.h 
alphabetizer.o: Alphabetizer.cpp Alphabetizer.h StringBST.h
testAlphabetizer.o: testAlphabetizer.cpp Alphabetizer.h   
